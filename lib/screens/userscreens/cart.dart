    ...
    return Scaffold(
      ...
      body: StreamBuilder<DocumentSnapshot<Map<String, dynamic>>>(
          ...
          builder: (context, snapShot) {
            double bwPrint = snapShot.data!.get("bwPrint");
            double bwXerox = snapShot.data!.get("bwXerox");
            double colorPrint = snapShot.data!.get("colorPrint");
            double colorXerox = snapShot.data!.get("colorXerox");
            double spiralBinding = snapShot.data!.get("spiralBinding");
            double thermalBinding = snapShot.data!.get("thermalBinding");
                                      ...
                                      documentBuilder:
                                        ...
                                        if (pdfDocument != null) {
                                          try {
                                            ...
                                            details[index].add((details[index]
                                                        [1] >
                                                    1
                                                ? (details[index][1] - 1) *
                                                    (pageCount *
                                                                                            ...
                                                                                            child: ClipRRect(
                                                                                              ...
                                                                                              child: MaterialButton(
                                                                                                onPressed: () {
                                                                                                  print(data);
                                                                                                  setState(() {
                                                                                                    data[7] = (details[index][1] > 1
                                                                                                        ? (details[index][1] - 1) * (pageCount * (details[index][2] ? colorXerox : bwXerox))
                                                                                                        : 0 +
